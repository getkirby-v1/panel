...
l::set(array(
  ...
  'form.buttons.blockquote' => 'bloc de texte',
  'form.buttons.code' => 'code',
  'form.buttons.hr' => 'hr',
  'form.buttons.ul' => 'ul',
  'form.buttons.ol' => 'ol',
  'form.buttons.youtube' => 'youtube',
  'form.buttons.vimeo' => 'vimeo',
  ...
  'form.overlay.youtube.title' => 'Insérer une vidéo Youtube',
  'form.overlay.youtube.link' => 'Lien Youtube',
  'form.overlay.youtube.width' => 'Largeur (pixels)',
  'form.overlay.youtube.height' => 'Hauteur (pixels)',
  'form.overlay.youtube.button' => 'Insérer la vidéo',
  
  'form.overlay.vimeo.title' => 'Insérer une vidéo Vimeo',
  'form.overlay.vimeo.link' => 'Lien Vimeo',
  'form.overlay.vimeo.width' => 'Largeur (pixels)',
  'form.overlay.vimeo.height' => 'Hauteur (pixels)',
  'form.overlay.vimeo.button' => 'Insérer la vidéo',
  
  'form.overlay.image.title' => 'Insérer une image',
  'form.overlay.image.width' => 'Largeur (pixels)',
  'form.overlay.image.height' => 'Hauteur (pixels)',
  'form.overlay.image.alt' => 'Texte alternatif (alt)',
  'form.overlay.image.class' => 'Classe CSS',
  'form.overlay.image.link' => 'Lien',
  'form.overlay.image.button' => 'Insérer l\'image',
  'form.overlay.image.images' => 'Images',
  'form.overlay.image.noimage' => 'Aucune image trouvée',
  'form.overlay.image.first' => '- Sélectionnez une image -',
