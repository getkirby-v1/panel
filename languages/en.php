...
l::set(array(
  ...
  'form.buttons.blockquote' => 'blockquote',
  ...
  'form.overlay.youtube.title' => 'Insert a Youtube video',
  'form.overlay.youtube.link' => 'Youtube link',
  'form.overlay.youtube.width' => 'Width (pixels)',
  'form.overlay.youtube.height' => 'Height (pixels)',
  'form.overlay.youtube.button' => 'Insert video',
  
  'form.overlay.vimeo.title' => 'Insert a Vimeo video',
  'form.overlay.vimeo.link' => 'Vimeo link',
  'form.overlay.vimeo.width' => 'Width (pixels)',
  'form.overlay.vimeo.height' => 'Height (pixels)',
  'form.overlay.vimeo.button' => 'Insert video',
  
  'form.overlay.image.title' => 'Insert an image',
  'form.overlay.image.width' => 'Width (pixels)',
  'form.overlay.image.height' => 'Height (pixels)',
  'form.overlay.image.alt' => 'Alternate text (alt)',
  'form.overlay.image.class' => 'CSS class',
  'form.overlay.image.link' => 'Link',
  'form.overlay.image.button' => 'Insert image',
  'form.overlay.image.images' => 'Images',
  'form.overlay.image.noimage' => 'No image found',
  'form.overlay.image.first' => '- Select an image -',
